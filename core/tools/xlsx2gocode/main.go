...
var (
	...
	genFile = flag.String("genFile", "./configtable", "config table gen go code file")

	mgrFile = flag.String("mgrFile", "./configtable/ConfigtableMgr.go", "config table gen mgr go code file")
